...
-- aliases
local focus_bg ="#837ab9"
local focus_fg  = "#000003"
local HOME = os.getenv("HOME")
local scripts = HOME .. '/.local/dev/hossein-lap/scripts/'
local dmenu = "dmenu_run -bw 1 -p 'run:' -sf '" .. focus_fg .. "' -sb '" .. focus_bg .. "' -nf '" .. focus_bg .. "' -nb '" .. focus_fg .. "'"
...
--  -- Custom keybindings
	-- bidi-terminal
	awful.key({ modkey, "Control" },			"t",	 function () awful.util.spawn("lxterminal") end,
